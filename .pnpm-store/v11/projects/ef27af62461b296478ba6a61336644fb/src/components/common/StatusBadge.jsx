const styles = {
  ...
  UPCOMING: "tw-bg-blue-100 tw-text-blue-700 dark:tw-bg-blue-900/40 dark:tw-text-blue-300",
  ...
  EXPIRED: "tw-bg-rose-100 tw-text-rose-700 dark:tw-bg-rose-900/40 dark:tw-text-rose-300",
  EXHAUSTED: "tw-bg-orange-100 tw-text-orange-700 dark:tw-bg-orange-900/40 dark:tw-text-orange-300",
